...
Komplett referens för alla PRECC-kommandon.

---

## precc init

Initiera PRECC och registrera hook i Claude Code.
...
Analysera sessionsloggar för fel-rättningsmönster.
...
Hantera automatiseringsfärdigheter.
...
Komprimera kontextfiler för att minska tokenanvändning.
...
Uppdatera PRECC till senaste versionen.
...
Spela in animerade GIF-filer från bash-skript (Pro).
...
Analysera misslyckade GitHub Actions-körningar (Pro).
...
Visa cache-ledtrådsinformation för det aktuella projektet.
...
Starta en Nushell-session med PRECC-integration.
