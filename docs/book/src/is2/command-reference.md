...
Tæmandi viðmið fyrir allar PRECC-skipanir.

---

## precc init

Ræsa PRECC og skrá hook í Claude Code.
...
Greina lotunarskrár fyrir villu-lagfæringar mynstur.
...
Þjappa samhengsskrám til að minnka táknanotkun.
...
Uppfæra PRECC í nýjustu útgáfu.
...
Stjórna nafnlausri fjarmælingu.
...
Taka upp hreyfimynda-GIF úr bash-skriftum (Pro).
...
Greina misheppnaðar GitHub Actions keyrslur (Pro).
...
Birta upplýsingar um skyndiminnisvísanir fyrir núverandi verkefni.
...
Ræsa Nushell-lotu með PRECC-samþættingu.
