...
PRECC (التصحيح التنبؤي للأخطاء لـ Claude Code) is a Rust tool that intercepts Claude Code bash commands via the official PreToolUse hook mechanism. It fixes errors *before they happen*, saving tokens and eliminating retry loops.
...
<thead><tr><th>النوع</th><th>العدد</th><th>متوسط التوفير %</th><th>Tokens saved</th></tr></thead>
...
<thead><tr><th>الإصدار</th><th>المستخدمون</th><th>Hook invocations</th><th>Tokens saved</th><th>Saving ratio</th></tr></thead>
