...
Huidige versie <span data-stat="current_version">--</span>:
...
| Gebruikers | <span data-stat="unique_users">--</span> |

### Besparingen per versie

<table id="version-breakdown" style="display:none">
<thead><tr><th>Versie</th><th>Gebruikers</th><th>Hook invocations</th><th>Tokens saved</th><th>Saving ratio</th></tr></thead>
<tbody><tr><td colspan="5"><em>Laden...</em></td></tr></tbody>
</table>

<small>Cijfers zijn schattingen. Elke voorkomen fout vermijdt een volledige herhalingscyclus: foutuitvoer, modelredenering en herhalingscommando. These numbers update automatically from anonymized telemetry.</small>
