...
Täydellinen viite kaikkiin PRECC-komentoihin.

---

## precc init

Alusta PRECC ja rekisteröi hook Claude Codeen.
...
Analysoi istuntolokit virhe-korjaus-mallien löytämiseksi.
...
Pakkaa kontekstitiedostot tokenien käytön vähentämiseksi.
...
Päivitä PRECC uusimpaan versioon.
...
Hallitse anonyymiä telemetriaa.
...
Tallenna animoituja GIF-tiedostoja bash-skripteistä (Pro).
...
Analysoi epäonnistuneet GitHub Actions -ajot (Pro).
...
Näytä välimuistivihjeet nykyiselle projektille.
...
Käynnistä Nushell-istunto PRECC-integraatiolla.
