...
PRECC (Ennakoiva virheenkorjaus Claude Codelle) is a Rust tool that intercepts Claude Code bash commands via the official PreToolUse hook mechanism. It fixes errors *before they happen*, saving tokens and eliminating retry loops.
...
<thead><tr><th>Versio</th><th>Käyttäjät</th><th>Hook invocations</th><th>Tokens saved</th><th>Saving ratio</th></tr></thead>
